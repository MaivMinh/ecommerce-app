...
public class KafkaConfig {
    ...
    @Value("${kafka.consumer.group-id:payment-service}")
    ...
    private DefaultErrorHandler paymentKafkaErrorHandler;

    @Autowired
    public void setPaymentKafkaErrorHandler(@Lazy DefaultErrorHandler paymentKafkaErrorHandler) {
        this.paymentKafkaErrorHandler = paymentKafkaErrorHandler;
    }
