...
public class KafkaConfig {
    ...
    @Value("${kafka.consumer.group-id:order-service}")
    ...
    private DefaultErrorHandler orderKafkaErrorHandler;

    @Autowired
    public void setOrderKafkaErrorHandler(@Lazy DefaultErrorHandler orderKafkaErrorHandler) {
        this.orderKafkaErrorHandler = orderKafkaErrorHandler;
    }
